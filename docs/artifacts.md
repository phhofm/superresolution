...
<!-- https://paperswithcode.com/task/jpeg-artifact-correction/latest -->
<!-- just use the few input images from this site, the examples :  https://huggingface.co/spaces/danielsapit/JPEG_Artifacts_Removal  -->
